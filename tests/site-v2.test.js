...
const publicChannels = buildPublicChannels(publicJobs, "2026-07-31");
...
const todayIds = new Set(
  builtIssues.filter((issue) => issue.date === "2026-07-31").flatMap((issue) => issue.job_ids)
);
...
assert.match(nextDaySection, /最新更新 <small>2026-07-31<\/small>/);
assert.deepEqual(
